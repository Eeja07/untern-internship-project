...
const DiscoverInternships = ({ activeTab: propActiveTab }) => {
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '24px' }}>
        <button
          ...
          style={{
            padding: '10px 24px',
            background: activeTab === 'search' ? '#007bff' : '#f8f9fa',
        ...
        <button
          ...
          style={{
            padding: '10px 24px',
            background: activeTab === 'featured' ? '#007bff' : '#f8f9fa',
            color: activeTab === 'featured' ? 'white' : '#007bff',
            border: '1px solid #007bff',
            borderRadius: '8px',
            cursor: 'pointer',
            fontWeight: 'bold'
      ...
      {activeTab === 'featured' ? (
        <div>
          {/* Featured Internships Section only */}
          <div style={{
            ...
            <p style={{ margin: '0 0 20px 0', opacity: 0.9 }}>
              Most popular internship opportunities based on application count. Browse through {featuredInternships.length} available positions.
            </p>
            ...
            <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
              <div style={{
                ...
                <strong>{featuredInternships.length}</strong> Total Opportunities
              </div>
              <div style={{
                background: 'rgba(255,255,255,0.2)',
                padding: '10px 15px',
